...
#
# Script generated by Vivado on Wed Jan 08 08:45:35 +0700 2025
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : uart_fifo_axi.sh
...
#
# Usage        : uart_fifo_axi.sh
#                uart_fifo_axi.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                uart_fifo_axi.sh [-reset_run]
#                uart_fifo_axi.sh [-reset_log]
#                uart_fifo_axi.sh [-help]
#
...
#                script (type 'uart_fifo_axi.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname xil_defaultlib -libname fifo_generator_v13_2_9 -libname util_vector_logic_v2_0_3 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm xil_defaultlib fifo_generator_v13_2_9 util_vector_logic_v2_0_3)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "uart_fifo_axi.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./uart_fifo_axi.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.uart_fifo_axi xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.uart_fifo_axi -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log uart_fifo_axi_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./uart_fifo_axi.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: uart_fifo_axi.sh [-help]\n\
Usage: uart_fifo_axi.sh [-step]\n\
Usage: uart_fifo_axi.sh [-lib_map_path]\n\
Usage: uart_fifo_axi.sh [-reset_run]\n\
Usage: uart_fifo_axi.sh [-reset_log]\n\
Usage: uart_fifo_axi.sh [-keep_index]\n\
Usage: uart_fifo_axi.sh [-noclean_files]\n\n\
