...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L fifo_generator_v13_2_9 -L util_vector_logic_v2_0_3 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot uart_fifo_axi xil_defaultlib.uart_fifo_axi xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim uart_fifo_axi -key {Behavioral:sim_1:Functional:uart_fifo_axi} -tclbatch cmd.tcl -protoinst "protoinst_files/zynq_uart_fifo_axi.protoinst" -protoinst "protoinst_files/uart_fifo_axi.protoinst" -protoinst "protoinst_files/fifo.protoinst" -protoinst "protoinst_files/uart_fifo_axi_hw_inst_1.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb uart_fifo_axi.wdb xsim.dir libdpi.so)
