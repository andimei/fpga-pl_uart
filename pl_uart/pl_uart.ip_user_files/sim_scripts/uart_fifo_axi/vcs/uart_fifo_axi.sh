...
design_libs=(xilinx_vip xpm xil_defaultlib fifo_generator_v13_2_9 util_vector_logic_v2_0_3)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.uart_fifo_axi xil_defaultlib.glbl -o uart_fifo_axi_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./uart_fifo_axi_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key uart_fifo_axi_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc uart_fifo_axi_simv.daidir vcs_lib c.obj)
