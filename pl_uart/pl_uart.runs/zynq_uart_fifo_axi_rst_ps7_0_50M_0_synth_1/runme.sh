...
HD_PWD='D:/FPGA/fpga-pl_uart/pl_uart/pl_uart.runs/zynq_uart_fifo_axi_rst_ps7_0_50M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_uart_fifo_axi_rst_ps7_0_50M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_uart_fifo_axi_rst_ps7_0_50M_0.tcl
