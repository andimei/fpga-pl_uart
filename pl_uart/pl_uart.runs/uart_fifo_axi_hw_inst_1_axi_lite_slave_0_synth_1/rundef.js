...
ISEStep( "vivado",
         "-log uart_fifo_axi_hw_inst_1_axi_lite_slave_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_fifo_axi_hw_inst_1_axi_lite_slave_0.tcl" );
