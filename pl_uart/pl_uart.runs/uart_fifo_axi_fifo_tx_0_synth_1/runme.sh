...
HD_PWD='D:/FPGA/fpga-pl_uart/pl_uart/pl_uart.runs/uart_fifo_axi_fifo_tx_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_fifo_axi_fifo_tx_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_fifo_axi_fifo_tx_0.tcl
