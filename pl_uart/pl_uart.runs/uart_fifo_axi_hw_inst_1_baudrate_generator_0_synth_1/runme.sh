...
HD_PWD='D:/FPGA/fpga-pl_uart/pl_uart/pl_uart.runs/uart_fifo_axi_hw_inst_1_baudrate_generator_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_fifo_axi_hw_inst_1_baudrate_generator_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_fifo_axi_hw_inst_1_baudrate_generator_0.tcl
