...
HD_PWD='D:/FPGA/fpga-pl_uart/pl_uart/pl_uart.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_uart_fifo_axi_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_uart_fifo_axi_wrapper.tcl
