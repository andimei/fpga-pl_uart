...
HD_PWD='D:/FPGA/fpga-pl_uart/pl_uart/pl_uart.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_uart_fifo_axi_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zynq_uart_fifo_axi_wrapper.tcl -notrace
