...
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ design_uart_uart_tx_0_0_sim_netlist.vhdl
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_uart_tx is
  ...
  signal o_TX_DONE_TICK_INST_0_i_1_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_state_reg[1]_i_2\ : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of \b_reg[0]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \b_reg[1]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \b_reg[2]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \b_reg[3]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \b_reg[4]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \b_reg[5]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \b_reg[6]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \b_reg[7]_i_2\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \n_reg[1]_i_2\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \n_reg[1]_i_3\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of o_TX_DONE_TICK_INST_0 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of o_TX_DONE_TICK_INST_0_i_1 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \s_reg[1]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \s_reg[2]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of tx_reg_i_1 : label is "soft_lutpair4";
begin
\FSM_sequential_state_reg[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFF0F0F00AA30AA"
    )
        port map (
      I0 => i_TX_START,
...
\n_reg[1]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
o_TX_DONE_TICK_INST_0: unisim.vcomponents.LUT3
    generic map(
      INIT => X"08"
    )
        port map (
...
o_TX_DONE_TICK_INST_0_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFFFFFF"
    )
        port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute CHECK_LICENSE_TYPE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "design_uart_uart_tx_0_0,uart_tx,{}";
